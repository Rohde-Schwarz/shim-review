...
Subject: CN = Rohde & Schwarz Cybersecurity GmbH, O = Rohde & Schwarz Cybersecurity GmbH, STREET = Muehldorfstr. 15, L = Muenchen, S = Bayern, C = DE
```
...
*******************************************************************************
Please use the Dockerfile in https://github.com/Rohde-Schwarz/shim-review/tree/rohdeschwarz-shim-x64-20251001 to build and verify our shim bootloader.
...
We need it for our pre-boot authentication code, which is built with the Microsoft Visual Compiler. Unfortunately the Microsoft Visual Compiler is not able to use the linux System V ABI, and so we had to switch to MS ABI.
...
*******************************************************************************
https://github.com/Rohde-Schwarz/shim-review/blob/rohdeschwarz-shim-x64-20251001/build.log
