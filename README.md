...
https://opencorporates.com/companies/de/D2601V_HRB160333
...
Subject: CN = Rohde & Schwarz GmbH & Co. KG, O = Rohde & Schwarz GmbH & Co. KG, L = München, S = Bayern, C = DE
```
...
*******************************************************************************
- Name: Daniel Neus
- Position: Senior Expert Development Engineer
...
*******************************************************************************
Please use the Dockerfile in https://github.com/Rohde-Schwarz/shim-review/tree/rohdeschwarz-shim-x64-20250930 to build and verify our shim bootloader.

*******************************************************************************
### What patches are being applied and why:
Mention all the external patches and build process modifications, which are used during your building process, that make your shim binary be the exact one that you posted as part of this application.
*******************************************************************************
**disable-all-load-options.patch** (same patch as in pull request [#776](https://github.com/rhboot/shim/pull/776))

This patch adds a build option DISABLE_ALL_LOAD_OPTIONS to bypass the bootoption parsing and second stage loader name assembly. This code failed on some systems and produced a non-bootable name for the second stage loader. Because we are using a hardcoded path and filename for the second stage loader, we just bypass this code with this patch.
...
*******************************************************************************
Yes, the NX bit is set in our shim, and our entire boot stack is NX-compatible. We have validated this through extensive testing across a wide range of systems.
...
*******************************************************************************
All older signed shims are using SBAT revocation. No GRUB bootloader is used.
...
*******************************************************************************
Yes, please use the included Dockerfile to build and verify our shim bootloader.
...
*******************************************************************************
https://github.com/Rohde-Schwarz/shim-review/blob/rohdeschwarz-shim-x64-20250930/build.log
...
*******************************************************************************
We updated our embedded certificate, which now uses a 4k RSA key and is now valid until 2031.
...
**shim**
    ...
    shim.rscs,1,Rohde & Schwarz Cybersecurity GmbH,shim,16.1,https://www.rohde-schwarz.com/cybersecurity
